...
public class RingButton extends View {
    ...
    private int borderColor = R.color.accent;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            borderWidth = typedArray.getDimensionPixelSize(R.styleable.ringButton_btnborderWidth, dpToPx(context, dpToPx(context, BORDER_WIDTH)));
